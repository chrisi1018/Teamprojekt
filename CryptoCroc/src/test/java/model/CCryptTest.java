...
public class CCryptTest {
	...
	private String textOne = "Mpsfn jqtvn epmps tju bnfu, dpotfufuvs"
			+ " tbejqtdjoh fmjus, tfe ejbn opovnz fjsnpe"
			+ " ufnqps jowjevou vu mbcpsf fu epmpsf nbhob"
			+ " bmjrvzbn fsbu, tfe ejbn wpmvquvb. Bu wfsp fpt"
			+ " fu bddvtbn fu kvtup evp epmpsft fu fb sfcvn."
			+ " Tufu dmjub lbte hvcfshsfo, op tfb ubljnbub"
			+ " tboduvt ftu Mpsfn jqtvn epmps tju bnfu. "
			+ "Mpsfn jqtvn epmps tju bnfu, dpotfufuvs tbejqtdjoh "
			+ "fmjus, tfe ejbn opovnz fjsnpe ufnqps jowjevou"
			+ " vu mbcpsf fu epmpsf nbhob bmjrvzbn fsbu, tfe"
			+ " ejbn wpmvquvb. Bu wfsp fpt fu bddvtbn fu kvtup"
			+ " evp epmpsft fu fb sfcvn. Tufu dmjub lbte"
			+ " hvcfshsfo, op tfb ubljnbub tboduvt ftu Mpsfn"
			+ " jqtvn epmps tju bnfu.";
	
	private String textTwelve = "Xadqy ubegy paxad euf myqf"
			+ ", oazeqfqfgd empubeouzs qxufd,"
			+ " eqp pumy zazgyk qudyap fqybad"
			+ " uzhupgzf gf xmnadq qf paxadq ymszm"
			+ " mxucgkmy qdmf, eqp pumy haxgbfgm. Mf hqda"
			+ " qae qf moogemy qf vgefa pga paxadqe qf qm"
			+ " dqngy. Efqf oxufm wmep sgnqdsdqz, za eqm fmwuymfm"
			+ " emzofge qef Xadqy ubegy paxad euf myqf. Xadqy"
			+ " ubegy paxad euf myqf, oazeqfqfgd empubeouzs"
			+ " qxufd, eqp pumy zazgyk qudyap fqybad uzhupgzf"
			+ " gf xmnadq qf paxadq ymszm mxucgkmy qdmf, eqp pumy"
			+ " haxgbfgm. Mf hqda qae qf moogemy qf vgefa pga"
	...
	/**
	 * Testet die Cäsarverschlüsselung mit Buchstaben "A";
	 */
	@Test
	...
	/**
	 * Testet die Cäsarentschlüsselung mit Buchstaben "A";
	 */
	@Test
	...
	/**
	 * Testet die Cäsarverschlüsselung mit Buchstaben "B";
	 */
	@Test
	...
	/**
	 * Testet die Cäsarentschlüsselung mit Buchstaben "B";
	 */
	@Test
	...
	/**
	 * Testet die Cäsarverschlüsselung mit Buchstaben "M";
	 */
	@Test
	...
	/**
	 * Testet die Cäsarentschlüsselung mit Buchstaben "M";
	 */
	@Test
	...
	/**
	 * Testet die Cäsarverschlüsselung mit Buchstaben "z";
	 */
	@Test
	...
	/**
	 * Testet die Cäsarentschlüsselung mit Buchstaben "z";
	 */
	@Test
	...
	/**
	 * Testet wie die Verschlüsselung mit Unicodezeichen umgeht.
	 */
	@Test
	void unicodeTest() {
	...
	/**
	 * Testet die Verschlüsselung und Entschlüsselung mit zufälligem Text und zufälligen Schlüssel
	 */
	@Test
	void randomTest() {
		int leftLimit = 32;
	...
	/**
	 * Testet die checkKey Funktion mit Funktionalem Schlüssel
	 */
	@Test
	void keyTestRight() {
	...
	/**
	 * Testet die checkKey Funktion mit falschem Schlüssel
	 */
	@Test
	void keyTestWrong() {
	...
	/**
	 * Testet die checkKey Funktion mit zu Langem Schlüssel
	 */
	@Test
	void keyTestLong() {
